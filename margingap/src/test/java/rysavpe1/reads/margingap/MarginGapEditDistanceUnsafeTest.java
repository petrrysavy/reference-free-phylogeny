 ...
 * @author Petr Ryšavý
 */
public class MarginGapEditDistanceUnsafeTest {
    private MarginGapEditDistanceUnsafe editDistance;

    @Before
    public void init() {
        editDistance = new MarginGapEditDistanceUnsafe(0, 1, 1, new LinearMarginGapPenalty(1.0, 3, 2));
    }
    ...
    public void testGetDistance5() {
        editDistance = new MarginGapEditDistanceUnsafe(0, 1, 1, new LinearMarginGapPenalty(6.0/5.0, 6, 2));
    ...
    public void testFigure2() {
        editDistance = new MarginGapEditDistanceUnsafe(0, 1, 1, new LinearMarginGapPenalty(4.0/3.0, 4, 2));
