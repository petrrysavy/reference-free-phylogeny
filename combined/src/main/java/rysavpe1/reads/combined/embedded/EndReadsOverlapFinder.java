 ...
 */
public class EndReadsOverlapFinder implements EmbeddedOverlapFinder<int[]> {

    private final int readLength;
    private final EmbeddingFunction<Sequence, int[]> readsEmbedding;

    public EndReadsOverlapFinder(int readLength, EmbeddingFunction<Sequence, int[]> readsEmbedding) {
    ...
    public OverlapRegion getOverlap(EmbeddedSequence<int[]> a, EmbeddedSequence<int[]> b) {
        ...
        return SimpleOverlapRegion.byEnds(calculateDistance(left[minIndex], right[minIndex], aLeftEnd[minIndex], aRightEnd[minIndex], bLeftEnd[minIndex], bRightEnd[minIndex])
                , aLeftEnd[minIndex], aRightEnd[minIndex], bLeftEnd[minIndex], bRightEnd[minIndex]);
    }
